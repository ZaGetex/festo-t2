...
private:
    ...
    SimSlide *slide;
public:
    SimItemManager(std::vector<std::shared_ptr<SimItem>> *items, SimConveyorBelt *conveyor, SimSlide *slide);
    void addItem(ItemKinds kind=ItemKinds::flat, bool flip=false, bool sticky=false);
